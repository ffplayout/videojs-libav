...
archive_name="libav-6.10.9.0-patentfree-player-corresponding-source-${release_tag}.tar.xz"
...
printf '%s\n' \
  ...
  '' \
  'To reproduce the runtime, inspect project/libav/build/README.md, change into' \
  'project/, then run ./libav/build/build-patentfree-player.sh.' \
  > "$stage_dir/README.md"
